...
-- Type: [Style](https://xplr.dev/en/style)
xplr.config.general.focus_ui.style = { fg = "Gray", add_modifiers = { "Bold" } }
...
-- ```
xplr.config.node_types.extension.md = { meta = { icon = "" }, style = { fg = "Cyan" } }
...
xplr.config.node_types.extension.c = { meta = { icon = "ﭰ" } }
...
xplr.config.node_types.extension.pdf = { meta = { icon = "" } }
...
xplr.config.node_types.special["Trash"] = { meta = { icon = "" } }
xplr.config.node_types.special["Home"] = { meta = { icon = "" } }
xplr.config.node_types.special["Pictures"] = { meta = { icon = "" } }
xplr.config.node_types.special["config"] = { meta = { icon = "" } }
xplr.config.node_types.special[".config"] = { meta = { icon = "" } }
xplr.config.node_types.special[".git"] = { meta = { icon = "" } }
xplr.config.node_types.special[".github"] = { meta = { icon = "" } }
xplr.config.node_types.special[".fonts"] = { meta = { icon = "" } }
